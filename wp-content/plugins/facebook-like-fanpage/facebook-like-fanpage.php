<?php
/*
 Plugin Name: Facebook Like Fanpage Widget
 Plugin URI: https://google.com
 Description: This is a Widget to help you to add Facebook Like Fanpage box to your site, you can setting FB url, App ID in setting
 Version: 1.0      
 Author: The Anh     
 Author URI: http://www.google.com/               
 License: none                 
 */          
class TAFacebook_Like_Box extends WP_Widget {   
	function __construct() {  
		parent::__construct(     
			'wp_ta_fb_like_fanpage', // Base ID 
			__( 'Facebook Like Fanpage', 'ta-fb-like-box' ), // Name
			array( 'description' => __( 'Facebook Like Fanpage Widget!', 'ta-fb-like-box' ), ) // Args
		); 
		add_action('wp_head', array(&$this, 'TAadd_fb_script_to_head'));  
	}
	
	//add script to head
	function TAadd_fb_script_to_head(){
	...
	public function form( $instance ) {
        if ( isset( $instance['title'] ) ) {
            ...
            $title = __( 'Facebook Like Fanpage', 'ta-fb-like-box' );
        }
        ...
        if ( isset( $instance['page_username'] ) ) {
			...
			$page_username='https://www.facebook.com/dongydinhtuan/';
		}
        ...
        <p>
        	 <label><?php _e( 'Shortcode' ); ?>:</label><br />
 			 <code>[ta-likebox url="https://www.facebook.com/dongydinhtuan/" width="340" height="500" show_faces="true" show_Header="true" show_border="false" ]</code>
    <?php
    }
...
function register_TAfb_likebox_widget() {
    register_widget( 'TAFacebook_Like_Box' );
}
add_action( 'widgets_init', 'register_TAfb_likebox_widget' );

// Register Shortcode
function TAFacebook_Like_Box_add_shortcode( $atts ) {
	
	extract( shortcode_atts(
		array(
			'url' 			=> 'https://www.facebook.com/dongydinhtuan/',
			'width' 		=> '380',
			'height' 		=> '500',
			'show_faces' 	=> 'true',
			'show_Header' 	=> 'true',
...
add_shortcode( 'ta-likebox', 'TAFacebook_Like_Box_add_shortcode' );
