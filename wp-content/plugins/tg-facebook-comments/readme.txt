...
It also provides a shortcode [tg_facebook_comments] that can be inserted by you anywhere in any post or page or in any Text widget to display Facebook Comments with options and settings selected by you in the plugin options page.
...
= 1.5 =
* Added a shortcode [tg_facebook_comments] to display Facebook comments anywhere in any post or page or in any page through the Text widget.
...
= 1.5 =
Shortcode [tg_facebook_comments] added to display Facebook comments anywhere in any post or page or in any page through the Text widget.
